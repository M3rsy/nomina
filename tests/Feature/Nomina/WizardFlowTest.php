...
test('review renders action-scoped feedback and a delayed processing overlay', function () {
    ...
    Livewire::test(Revisar::class, ['payPeriod' => $payPeriod])
        ...
        ->assertSeeHtml('wire:target="continueToReady,confirmContinueToReady,startPayrollRun,saveAttendanceException,saveManualMark,saveEditRawMark,markCorrected,deleteRawMark,saveAssign,saveCreatedEmployee,reopenProcessedPeriod"')
