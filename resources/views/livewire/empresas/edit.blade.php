        ...
        <header class="rounded-3xl border border-slate-200/70 bg-white/90 p-5 shadow-sm backdrop-blur sm:p-6">
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div>
                    ...
                    <h1 class="mt-3 text-2xl font-black tracking-tight text-slate-950 sm:text-3xl">Editar empresa</h1>
                    <p class="mt-2 max-w-2xl text-sm text-slate-600">Actualizá los datos de la compañía y su estado operativo.</p>
                </div>
                <a
                    href="/empresas"
