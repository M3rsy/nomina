<div class="max-w-4xl mx-auto py-8">
    ...
    <form wire:submit="save" class="bg-white p-6 rounded-lg shadow space-y-4 mb-8">
        @if ($isSuperAdmin)
            <div>
        ...
        <button type="submit" class="bg-indigo-600 text-white py-2 px-4 rounded hover:bg-indigo-700">Guardar cambios</button>
    </form>
