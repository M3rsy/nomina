<x-ui.loading-button
    ...
    wire:confirm="¿Eliminar a {{ $employee->full_name }}? El registro dejará de estar disponible, pero su historial se conservará."
    aria-label="Eliminar a {{ $employee->full_name }}"
