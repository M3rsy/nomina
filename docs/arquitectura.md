...
- `Attendance/AttendanceShiftAnalyzer`: compara marcas observadas con la jornada, produce déficits y candidatos de hora extra completos, y conserva sus minutos y huellas exactas.
